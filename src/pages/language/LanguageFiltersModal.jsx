      ...
      >
        <div className='flex-1'>
          <div className='grid md:grid-cols-2 gap-x-10 gap-y-6'>
            <FormInput name='name' label='Name' placeholder='Language' />
            <FormInput name='code' label='Code' placeholder='Language Code' />
            <FormDropdown
              name='status'
              label='Status'
...
export default LanguageFiltersModal;

...
import LanguageEditModal from './language-edit-modal/LangaugeEditModal';
import LanguageViewModal from './language-view-modal/LanguageViewModal';

const LanguageTableActionBtn = (data) => {
...
export default LanguageTableActionBtn;
